...
public static class DemoMap
{
    public static MapDocument Create()
    {
        ...
        var wave = new CurveTrack { Name = L.Get("core.names.demoWave"), Kind = CurveKind.Bezier };
        ...
        var zigzag = new CurveTrack { Name = L.Get("core.names.demoZigzag"), Kind = CurveKind.Linear };
        ...
        var sweep = new CurveTrack { Name = L.Get("core.names.demoSweep"), Kind = CurveKind.Bezier };
