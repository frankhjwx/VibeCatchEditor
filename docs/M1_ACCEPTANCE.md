...
- VCE Slider 生成 Fruit、Droplet、TinyDroplet；全部对象严格贴合目标曲线，自动 SV 可提高到 1000，无解时显示诊断。Tick ×n 与编辑吸附独立。
...
VCE Slider 的 RNG 补偿仍受 X 边界、repeat 共享路径和 SV=1000 上限约束，不能宣称任意曲线都能无误差输出；无法满足强约束时不生成该轨迹。
