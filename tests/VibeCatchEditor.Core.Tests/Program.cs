...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Tiny boundary constraints are reported without hiding real offsets", ConversionTests.TinyBoundary),
    ...
    ("Conflicting repeated tiny targets fall back with an explicit diagnostic", EditableSliderTests.RepeatTinyConflict),
    ("Imported path families become editable without losing repeat events", EditableSliderTests.ImportToEditable),
